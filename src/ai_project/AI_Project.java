...
public class AI_Project {
 	...
 	private static Timetable initializeTimetable() {
		...
		timetable.addRoom(1, "CS1", 15);
		timetable.addRoom(2, "CS2", 30);
		timetable.addRoom(4, "CS3", 20);
		timetable.addRoom(5, "CS4", 25);
		...
		timetable.addProfessor(1, "Dr Kashif Zafar");
		timetable.addProfessor(2, "Mr Aamir Raheem");
		timetable.addProfessor(3, "Mr Amir Wali");
		timetable.addProfessor(4, "Mr Mubashir Baig");

		timetable.addModule(1, "cs1", "Computer Science", new int[] { 1, 2 });
		timetable.addModule(2, "en1", "English", new int[] { 1, 3 });
		timetable.addModule(3, "ma1", "Calculus", new int[] { 1, 2 });
		timetable.addModule(4, "ph1", "Basic Electronics", new int[] { 3, 4 });
		timetable.addModule(5, "hi1", "Islamiat", new int[] { 4 });
		timetable.addModule(6, "dr1", "Algorithms", new int[] { 1, 4 });
